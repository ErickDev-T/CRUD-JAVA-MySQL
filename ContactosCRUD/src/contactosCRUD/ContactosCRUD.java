...
public class ContactosCRUD extends javax.swing.JFrame {
    ...
    public ContactosCRUD() {
        try {
            ...
            Logger.getLogger(ContactosCRUD.class.getName()).log(Level.SEVERE, null, ex);
        }
        initComponents();
    ...
    private void initComponents() {
        ...
        popEliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/contactosCRUD/delete.png"))); // NOI18N
        ...
        pnlDatosUsuarios.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos Usuarios", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N

        txtID.setEditable(false);
        txtID.setToolTipText("ID del usuario");
        txtID.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ID", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        txtTelefonos.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Telefono", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        pnlDatosUsuariosLayout.setHorizontalGroup(
            ...
            .addGroup(pnlDatosUsuariosLayout.createSequentialGroup()
                .addGroup(pnlDatosUsuariosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlDatosUsuariosLayout.createSequentialGroup()
                        .addGap(72, 72, 72)
        ...
        pnlTablaDatos.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Listado de Usuarios", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        String insertarSQL = "INSERT INTO tbl_usuarios (nombres, apellidos, telefonos, correo) VALUES (?,?,?,?)";
        try {
            ...
            ps.setString(3, txtTelefonos.getText());
    ...
    private void tblUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuariosMouseClicked
        ...
        txtTelefonos.setText(this.tblUsuarios.getValueAt(fila, 3).toString());
        txtCorreo.setText(this.tblUsuarios.getValueAt(fila, 4).toString());
    }//GEN-LAST:event_tblUsuariosMouseClicked

    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        String actualizarSQL = "UPDATE tbl_usuarios SET nombres='" + txtNombres.getText()
    ...
    private void popEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_popEliminarActionPerformed
        if (JOptionPane.showConfirmDialog(rootPane, "Se eliminara el registro, desea continuar?", "Eliminar Registro",
            ...
            try {
                String Borrar = "DELETE FROM tbl_Usuarios WHERE id='" + txtID.getText() + "'";
                PreparedStatement ps;
    ...
    private void mostrarDatos(String valorBuscar) {
        String consultaSQL = "SELECT * FROM tbl_usuarios WHERE CONCAT(nombres,'',apellidos) LIKE '%" + valorBuscar + "%'";
